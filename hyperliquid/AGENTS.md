...
## Environment
- `.env.local` requires `OPENFORT_PUBLISHABLE_KEY`, `SHIELD_PUBLISHABLE_KEY`, `SHIELD_ENCRYPTION_SHARE`, `OPENFORT_SHIELD_RECOVERY_BASE_URL`, `OPENFORT_ETHEREUM_PROVIDER_POLICY_ID`, and `HYPERLIQUID_WALLET_ADDRESS`.
